            ...
            <div className="container-fluid white-box fade-in">
              <div className="row">
                <div className="col-xs-12">
                  ...
                  <br/><br/>
                  Vi når frem til 70% i 2030 og neutralitet i 2040 på følgende vis: Ifølge FN's klimapanels 1,5 graders rapport fra 2018 har vi globalt et resterende CO2-budget på ca. 500 gigatons hvis vi vil undgå global opvarmning på mere end 1,5 grader. Hvis vi giver Danmark en andel af dette budget, som svarer til vores andel af de globale udledninger på ca. 1 promille, betyder det et CO2-budget på 500 millioner tons. Hvis vi reducerer med 2,5 millioner tons om året fra vores nuværende udledning på ca. 50 millioner tons om året startende i 2020, vil vi kunne holde os nogenlunde inden for rammen af dette CO2-budget. I så fald vil vi ramme 20 millioner tons ca. i 2030 (svarende til 70% reduktion fra basisår 1990) og opnå CO2-neutralitet ca. i 2040.
                  <br/><br/>
