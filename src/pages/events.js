          ...
          <div className="col-sm-8 col-sm-offset-2 col-xs-12">
            <div className="container-fluid white-box fade-in">
              <div className="row">
                ...
                <script src='https://actionnetwork.org/widgets/v3/event_campaign/middagstest?format=js&source=widget&style=full'></script><div id='can-event_campaign-area-middagstest' style={{width: '100%'}}></div>
                </div>
              </div>
            </div>
          </div>
