    ...
    render() {
        ...
        return (
            ...
            <div className={styles.barcountWrapper}>
                <p className={this.state.amountTitle ? '' : styles.dataLoading} style={{left: this.state.percentage ? this.state.percentage + '%' : 0}}>{this.state.amountTitle ? this.state.amountTitle : 'Henter data' }</p>
